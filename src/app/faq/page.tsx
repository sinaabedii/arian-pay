...
const FAQData = [
  {
    ...
    questions: [
      {
        id: "credit-1",
        question: "چگونه می‌توانم از آرین پی اعتبار دریافت کنم؟",
      ...
      {
        id: "credit-2",
        question: "سقف اعتبار آرین پی چقدر است؟",
      ...
      },
      {
        ...
        answer: "خیر، در آرین پی نیازی به ارائه ضامن یا چک نیست. ما با استفاده از الگوریتم‌های پیشرفته اعتبارسنجی و بررسی سوابق مالی، اعتبار شما را تعیین می‌کنیم."
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: "installment-1",
        question: "از چه فروشگاه‌هایی می‌توانم با اعتبار آرین پی خرید کنم؟",
        answer: "شما می‌توانید از تمام فروشگاه‌های طرف قرارداد آرین پی، اعم از فروشگاه‌های آنلاین و فروشگاه‌های فیزیکی، خرید اقساطی انجام دهید. لیست کامل فروشگاه‌ها در بخش 'فروشگاه‌ها' قابل مشاهده است."
      },
      {
        id: "installment-2",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "wallet-3",
        question: "آیا استفاده از کیف پول آرین پی هزینه‌ای دارد؟",
        answer: "خیر، استفاده از کیف پول آرین پی کاملاً رایگان است و هیچ کارمزدی برای تراکنش‌های شارژ و پرداخت دریافت نمی‌شود."
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: "security-1",
        question: "آیا اطلاعات شخصی و مالی من در آرین پی امن است؟",
      ...
      },
      {
        ...
        answer: "در صورت سرقت یا گم شدن گوشی، سریعاً با پشتیبانی آرین پی تماس بگیرید تا حساب شما را موقتاً مسدود کنیم. همچنین می‌توانید از طریق رایانه یا دستگاه دیگری وارد حساب خود شده و رمز عبور را تغییر دهید."
      }
    ]
  }
];
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-lg text-secondary text-center">
                پاسخ سوالات رایج درباره خدمات آرین پی را در این بخش بیابید.
              </p>
