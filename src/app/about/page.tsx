            ...
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 leading-relaxed">
                  سعید پی یک پلتفرم پرداخت اعتباری و خرید اقساطی آنلاین است که
                  با هدف تسهیل فرآیند خرید اقساطی برای مشتریان و فروشگاه‌ها
                  ایجاد شده است.
                </p>
              </div>
              ...
              <div className="space-y-8">
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    مأموریت ما ارائه راهکارهای پرداخت اعتباری ساده، سریع و قابل
                    اعتماد به کاربران است. ما معتقدیم که دسترسی به اعتبار
                    منصفانه حق همه است و تلاش می‌کنیم تا فرآیند اعتبارسنجی و
                    پرداخت اقساطی را برای همه آسان کنیم.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    تیم سعید پی متشکل از متخصصان حوزه فین‌تک، توسعه نرم‌افزار و
                    اعتبارسنجی است که با سال‌ها تجربه در صنعت مالی، این پلتفرم
                    را ایجاد کرده‌اند.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    هدف ما ایجاد یک اکوسیستم پرداخت منسجم است که به کاربران
                    امکان می‌دهد با خیال راحت و بدون نیاز به فرآیندهای پیچیده،
                    از خدمات اعتباری بهره‌مند شوند.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          دریافت اعتبار در کمتر از 10 دقیقه با احراز هویت ساده
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          استفاده از استانداردهای امنیتی بانکی و حفظ حریم خصوصی
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          برنامه‌های پرداخت اقساطی متنوع متناسب با نیاز شما
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          مدیریت اعتبار، اقساط و پول نقد در یک پلتفرم واحد
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          تهران، خیابان ولیعصر، برج سعید، طبقه 10
                        </p>
                      </div>
                    </div>
                  </div>
