...
import { PaymentAnimation, ScanPaperAnimation } from "@/components/ui/animation";
...
export default function WebAppStyleHomePage() {
  ...
  const CounterAnimation = ({ end, duration = 2000, suffix = "" }: CounterAnimationProps) => {
    ...
    return (
      <span id={`counter-${end}`} className="font-bold text-2xl sm:text-3xl text-blue-600">
        {Math.floor(count).toLocaleString('fa-IR')}{suffix}
      </span>
    );
  };

  // Navigation items for webapp style
  const navItems = [
    { id: 'dashboard', label: 'داشبورد', icon: Home, href: '/dashboard', active: true },
  ...
  const features = [
    {
      ...
      description: "بدون مراجعه حضوری و تنها با بارگذاری مدارک، هویت شما به صورت آنلاین تأیید می‌شود.",
      color: "from-blue-500 to-blue-600"
    },
    {
      icon: Smartphone,
      title: "اپلیکیشن موبایل",
      description: "با اپلیکیشن موبایل سعید پی، به راحتی اعتبار و اقساط خود را مدیریت کنید.",
      color: "from-purple-500 to-purple-600"
    },
    {
      icon: Zap,
      title: "تأیید آنی اعتبار",
      description: "پس از تکمیل مدارک، در کمتر از ۱۰ دقیقه اعتبار شما تأیید و فعال می‌شود.",
      color: "from-orange-500 to-orange-600"
    },
    {
      icon: ShoppingBag,
      title: "خرید آنلاین و حضوری",
      description: "از فروشگاه‌های آنلاین خرید کنید یا در فروشگاه‌های فیزیکی با اسکن QR خرید نمایید.",
      color: "from-green-500 to-green-600"
    },
    {
      icon: Gift,
      title: "کد تخفیف اختصاصی",
      description: "با خرید‌های منظم و پرداخت به موقع اقساط، کدهای تخفیف ویژه دریافت کنید.",
      color: "from-pink-500 to-pink-600"
    },
    {
      icon: HeadphonesIcon,
      title: "پشتیبانی ۲۴/۷",
      description: "در هر ساعت از شبانه‌روز، کارشناسان ما آماده پاسخگویی به سؤالات شما هستند.",
  ...
  const testimonials = [
    {
      ...
      content: "تجربه فوق‌العاده‌ای بود. در کمتر از 15 دقیقه اعتبارم تایید شد و توانستم گوشی موردنظرم را به صورت اقساطی خریداری کنم.",
      rating: 5,
      avatar: "ر",
      date: "۲ ماه پیش"
    },
    {
      name: "مریم اکبری",
      role: "خرید لپ‌تاپ",
      content: "بدون نیاز به ضامن و چک توانستم لپ‌تاپ موردنیازم را خریداری کنم. اقساط منعطف و متناسب با بودجه من تنظیم شد.",
      rating: 4,
      avatar: "م",
      date: "۱ ماه پیش"
    },
    {
      ...
      content: "برای جهیزیه نیاز به خرید چند قلم لوازم خانگی داشتم. با سعید پی توانستم همه را یکجا خریداری کنم و در اقساط 12 ماهه پرداخت کنم.",
      rating: 5,
      avatar: "ع",
      date: "۳ هفته پیش"
    }
  ...
  const partnerStores = [
    { name: "دیجی‌کالا", category: "فروشگاه آنلاین", logo: "🛒", discount: "تا ۱۵٪ تخفیف" },
    { name: "بامیلو", category: "مد و پوشاک", logo: "👕", discount: "تا ۲۰٪ تخفیف" },
    { name: "ایران خودرو", category: "خودرو", logo: "🚗", discount: "اقساط ۶۰ ماهه" },
    { name: "سامسونگ", category: "موبایل و لپ‌تاپ", logo: "📱", discount: "اقساط ۲۴ ماهه" },
    { name: "ال جی", category: "لوازم خانگی", logo: "🏠", discount: "اقساط ۳۶ ماهه" },
    { name: "طلای مهر", category: "جواهرات", logo: "💍", discount: "تا ۱۰٪ تخفیف" },
  ];

  const stats = [
    { number: 500, suffix: '+', label: 'فروشگاه طرف قرارداد', icon: ShoppingBag, color: 'bg-blue-500' },
    { number: 50000, suffix: '+', label: 'کاربر فعال', icon: Users, color: 'bg-green-500' },
    { number: 98, suffix: '%', label: 'رضایت مشتریان', icon: Star, color: 'bg-yellow-500' },
    { number: 10, suffix: ' دقیقه', label: 'فعالسازی اعتبار', icon: Clock, color: 'bg-purple-500' }
  ];
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="text-center lg:text-right space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <Link href="/stores">
                    <Button variant="outline" size="lg" className="border-gray-300 px-8 py-4 rounded-xl font-medium">
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative">
                    ...
                    <div className="p-6 sm:p-8 text-white relative z-10 h-full flex flex-col justify-between">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-xl sm:text-2xl font-bold">۱۵,۰۰۰,۰۰۰ ریال</p>
                        </div>
                  ...
                  <div className="absolute inset-0 -z-10">
                    ...
                    <div className="absolute bottom-8 left-4 w-24 h-24 bg-purple-200 rounded-full opacity-20 animate-pulse" style={{animationDelay: '1s'}}></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                با سیستم پرداخت هوشمند سعید پی، پرداخت اقساط خود را به آسانی مدیریت کنید
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {features.map((feature, index) => (
                <div key={index} className="group bg-gray-50 hover:bg-white rounded-2xl p-6 transition-all duration-300 hover:shadow-lg border border-transparent hover:border-gray-200">
                ...
                {[
                  {
                    ...
                    description: "اطلاعات شخصی و مدارک هویتی خود را بارگذاری کنید",
                    icon: FileText,
                    color: "bg-blue-500"
                  },
                  {
                    step: 2,
                    title: "دریافت اعتبار",
                    description: "در کمتر از ۱۰ دقیقه اعتبار شما تایید و فعال می‌شود",
                    icon: CreditCard,
                    color: "bg-green-500"
                  },
                  {
                    step: 3,
                    title: "خرید اقساطی",
                    description: "از فروشگاه‌های طرف قرارداد به صورت اقساطی خرید کنید",
                    icon: ShoppingBag,
                    color: "bg-purple-500"
                  }
                ].map((item, index) => (
                  <div key={index} className="relative">
                    ...
                    <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow relative z-10 h-full">
                      {/* Step Number */}
                      <div className={`w-12 h-12 ${item.color} rounded-xl flex items-center justify-center text-white font-bold text-lg mb-4 mx-auto lg:mr-0 lg:ml-auto`}>
                        {item.step}
                      </div>
        ...
        <section className="px-4 py-12 lg:py-16 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="relative max-w-5xl mx-auto">
                  ...
                  {partnerStores.map((store, index) => (
                    <div
                      ...
                      className={`absolute inset-0 flex flex-col md:flex-row items-center transition-opacity duration-500 ${
                        index === activeStore ? 'opacity-100 z-10' : 'opacity-0 z-0'
                      }`}
                    >
                      ...
                      <div className="md:w-1/2 p-8 text-center md:text-right bg-gray-50 h-full flex flex-col justify-center">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{store.name}</h3>
                        <p className="text-gray-600 mb-6">{store.category}</p>
                        <Link href={`/stores/${store.name.replace(/\s+/g, '-').toLowerCase()}`}>
                          <Button variant="outline" className="mx-auto md:mr-0 md:ml-auto border-gray-300 hover:border-blue-600 hover:text-blue-600">
                            مشاهده محصولات
              ...
              {/* Store Grid - Small Items */}
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6">
                {partnerStores.map((store, index) => (
                  <div key={index} className="bg-gray-50 hover:bg-white rounded-2xl p-4 lg:p-6 transition-all duration-300 hover:shadow-md border border-transparent hover:border-gray-200 group">
                    <div className="text-center">
                      <div className="text-3xl lg:text-4xl mb-3">{store.logo}</div>
